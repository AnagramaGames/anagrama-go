...
// ANAGRAMA_BASE_URL). This should be used to initialize new clients.
func DefaultClientOptions() []option.RequestOption {
	defaults := []option.RequestOption{option.WithEnvironmentProduction()}
	if o, ok := os.LookupEnv("ANAGRAMA_BASE_URL"); ok {
		defaults = append(defaults, option.WithBaseURL(o))
	}
	if o, ok := os.LookupEnv("ANAGRAMA_API_KEY"); ok {
...
// environment (ANAGRAMA_API_KEY, ANAGRAMA_BASE_URL). The option passed in as
...
func NewClient(opts ...option.RequestOption) (r Client) {
	...
	r.Puzzles = NewPuzzleService(opts...)
	r.Dictionary = NewDictionaryService(opts...)
