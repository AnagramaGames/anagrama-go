...
<a href="https://pkg.go.dev/github.com/stainless-sdks/anagrama-go"><img src="https://pkg.go.dev/badge/github.com/stainless-sdks/anagrama-go.svg" alt="Go Reference"></a>
...
```go
import (
	"github.com/stainless-sdks/anagrama-go" // imported as anagramasdk
)
```
...
```sh
go get -u 'github.com/stainless-sdks/anagrama-go@v0.1.0'
```
...
See the [full list of request options](https://pkg.go.dev/github.com/stainless-sdks/anagrama-go/option).
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/anagrama-go/issues) with questions, bugs, or suggestions.
