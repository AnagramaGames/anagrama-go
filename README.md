...
<a href="https://pkg.go.dev/github.com/AnagramaGames/anagrama-go"><img src="https://pkg.go.dev/badge/github.com/AnagramaGames/anagrama-go.svg" alt="Go Reference"></a>
...
```sh
go get -u 'github.com/AnagramaGames/anagrama-go@v0.0.1'
```
...
See the [full list of request options](https://pkg.go.dev/github.com/AnagramaGames/anagrama-go/option).
...
We are keen for your feedback; please open an [issue](https://www.github.com/AnagramaGames/anagrama-go/issues) with questions, bugs, or suggestions.
